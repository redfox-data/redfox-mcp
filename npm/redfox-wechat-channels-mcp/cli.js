...
const binName = platform === "win32" ? "redfox-wechat-channels-mcp.exe" : "redfox-wechat-channels-mcp";
...
child.on("error", (err) => {
  process.stderr.write(`Failed to start redfox-wechat-channels-mcp: ${err.message}\n`);
  process.exit(1);
});
